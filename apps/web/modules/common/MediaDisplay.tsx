import { MovieCalendarItem, TvCalendarItem } from '@homarr/graphql';
...
export function RadarrMediaDisplay({ media }: { media: MovieCalendarItem }) {
  return (
    <MediaDisplay
      media={{
...
export function SonarrMediaDisplay({ media }: { media: TvCalendarItem }) {
  return (
    <MediaDisplay
      media={{
        genres: media.genres,
